...
var specificurl = [
    ...
    {
        name: 'Solar movie(new)',
        icon: 'fa-solid fa-sun',
        url: (q) => `https://thesolarmovie.co/?s=${q}`,
        baseUrl: 'https://thesolarmovie.co/'
    },
    {
        name: 'Solar movie(old)',
        icon: 'fa-solid fa-sun',
        url: (q) => `https://solarmoviesz.tv/home?search=${q}`,
        baseUrl: 'https://solarmoviesz.tv/'
    },
    {
        name: 'FullRaces',
